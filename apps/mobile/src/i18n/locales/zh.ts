...
export const zh: Catalog = {
  ...
  wizard: {
    ...
    rChannels: "渠道",
    channelsHint: "当此监控触发时，我们该如何通知你？可多选。",
    selectAll: "全选",
    chPush: "通知",
    chPushD: "在你的手机上即时收到推送。",
    chAlarm: "警报",
    chAlarmD: "你的手机响铃；带声音的全屏提醒。",
    chTelegramD: "以 Telegram 消息接收。",
    chEmailD: "通过邮件接收更新。",
    chWhatsappD: "以 WhatsApp 消息接收。",
    relayBadge: "账户",
    relayNote:
  ...
  alarm: {
    title: "警报",
    defaultBody: "你一直关注的变化已经发生。",
    stop: "停止",
    snooze: "稍后 5 分钟提醒",
    a11yScreen: "警报屏幕 — 你一直关注的事件已经发生",
  },
  sub: {
    currentPlan: "当前计划",
    compare: "套餐功能",
    recommended: "推荐",
    featFreeWatches: "3 个活跃监控",
    featFreeFreq: "每小时检查",
    featFreeChannels: "推送通知",
    featFreeAssistant: "AI 监控助手",
    featProWatches: "100 个活跃监控",
    featProFreq: "最快每分钟检查",
    featProAlarm: "警报（响亮）提醒",
    featProSounds: "100 种通知音",
    featProChannels: "Telegram · WhatsApp · 邮件",
    featProSupport: "优先支持",
    proName: "专业计划",
    freeName: "免费计划",
    minFreq: "每 {{n}} 分钟检查",
