...
export const en: Catalog = {
  ...
  wizard: {
    ...
    channelsHint: "When this watch triggers, how should we reach you? You can pick more than one.",
    selectAll: "Select all",
    chPush: "Notification",
    chPushD: "Get an instant push on your phone.",
    chAlarm: "Alarm",
    chAlarmD: "Your phone rings; full-screen alert with sound.",
    chTelegramD: "Receive it as a Telegram message.",
    chEmailD: "Receive the update by email.",
    chWhatsappD: "Receive it as a WhatsApp message.",
    relayBadge: "account",
    relayNote:
  ...
  alarm: {
    title: "Alarm",
    defaultBody: "The change you were watching for happened.",
    stop: "Stop",
    snooze: "Snooze 5 minutes",
    a11yScreen: "Alarm screen — the event you were watching happened",
  },
  sub: {
