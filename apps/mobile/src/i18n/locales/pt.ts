...
export const pt: Catalog = {
  onboarding: {
    skip: "Pular",
    next: "Avançar",
    createFirst: "Crie seu primeiro monitoramento",
    later: "Talvez depois",
    s1Title: "Boas-vindas ao Whenly",
    s1Body:
      "O Whenly observa o mundo real por você — quedas de preço, vagas de agendamento, anúncios de resultados e mais.",
    s2Title: "É só dizer com suas palavras",
    s2Body: "Descreva o que quer acompanhar; a IA encontra a fonte e mantém você informado.",
  ...
  wizard: {
    ...
    titles: {
      ...
      channels: "Como devemos te alertar?",
      alarm: "Som de alarme",
    ...
    alarmStudioTitle: "Estúdio de alarme",
    alarmStudioHint:
      "Escolha e ouça o som que tocará quando este monitoramento disparar um alarme.",
    siteOk: "Esta fonte parece aberta ao monitoramento automático.",
    siteLimited:
      "O monitoramento direto desta fonte pode ser limitado; vou acompanhar o anúncio público relacionado.",
  },
  alarm: {
    title: "Alarme",
  ...
  sub: {
    ...
    compare: "Recursos do plano",
    recommended: "Recomendado",
    featFreeWatches: "3 monitoramentos ativos",
    featFreeFreq: "Verificações a cada hora",
    featFreeChannels: "Notificações push",
    featFreeAssistant: "Assistente de monitoramento com IA",
    featProWatches: "100 monitoramentos ativos",
    featProFreq: "Verificações até a cada minuto",
    featProAlarm: "Alertas de alarme (sonoros)",
    featProSounds: "100 sons de notificação",
    featProChannels: "Telegram · WhatsApp · e-mail",
    featProSupport: "Suporte prioritário",
