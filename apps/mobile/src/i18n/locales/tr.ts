...
export const tr = {
  ...
  wizard: {
    ...
    channelsHint:
      "Bu izleme gerçekleşince hangi yollarla haber verelim? Birden fazlasını seçebilirsin.",
    selectAll: "Hepsini seç",
    chPush: "Bildirim",
    chPushD: "Telefonuna anlık bildirim gelir.",
    chAlarm: "Alarm",
    chAlarmD: "Telefonun çalar; tam ekran uyarı ve ses.",
    chTelegramD: "Telegram'dan mesaj olarak al.",
    chEmailD: "Gelişmeyi e-posta olarak al.",
    chWhatsappD: "WhatsApp mesajı olarak al.",
    relayBadge: "hesap",
    relayNote:
  ...
  alarm: {
    title: "Alarm",
    defaultBody: "İzlediğin gelişme gerçekleşti.",
    stop: "Durdur",
    snooze: "5 dakika ertele",
    a11yScreen: "Alarm ekranı — izlediğin olay gerçekleşti",
  },
  sub: {
    currentPlan: "MEVCUT PLAN",
    compare: "Plan özellikleri",
    recommended: "Önerilen",
    featFreeWatches: "3 aktif izleme",
    featFreeFreq: "Saatte bir kontrol",
    featFreeChannels: "Anlık bildirimler",
    featFreeAssistant: "Yapay zekâ izleme asistanı",
    featProWatches: "100 aktif izleme",
    featProFreq: "Dakikada bire kadar kontrol",
    featProAlarm: "Alarm (yüksek sesli) uyarılar",
    featProSounds: "100 bildirim sesi",
    featProChannels: "Telegram · WhatsApp · e-posta",
    featProSupport: "Öncelikli destek",
