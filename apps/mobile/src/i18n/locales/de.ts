...
export const de: Catalog = {
  onboarding: {
    skip: "Überspringen",
    next: "Weiter",
    createFirst: "Erstelle deine erste Überwachung",
    later: "Vielleicht später",
    s1Title: "Willkommen bei Whenly",
    s1Body:
      "Whenly beobachtet die echte Welt für dich — Preissenkungen, freie Termine, Ergebnisankündigungen und mehr.",
    s2Title: "Sag es einfach in eigenen Worten",
    s2Body:
      "Beschreibe, was du verfolgen willst; die KI findet die Quelle und hält dich auf dem Laufenden.",
  ...
  common: {
    ...
    openMapA11y: "Ort in Karte öffnen: {{coords}}",
  },
  login: {
  ...
  sub: {
    ...
    compare: "Plan-Funktionen",
    recommended: "Empfohlen",
    featFreeWatches: "3 aktive Überwachungen",
    featFreeFreq: "Stündliche Prüfungen",
    featFreeChannels: "Push-Benachrichtigungen",
    featFreeAssistant: "KI-Überwachungsassistent",
    featProWatches: "100 aktive Überwachungen",
    featProFreq: "Prüfungen bis zu jede Minute",
    featProAlarm: "Alarm-Warnungen (laut)",
    featProSounds: "100 Benachrichtigungstöne",
    featProChannels: "Telegram · WhatsApp · E-Mail",
    featProSupport: "Priorisierter Support",
  ...
  appearance: {
    title: "Darstellung",
    intro: "Passe Thema, Akzentfarbe und Bewegung der App an.",
    theme: "Thema",
    accent: "Akzentfarbe",
    accentHint: "Schaltflächen, Überschriften und Hervorhebungen nehmen diese Farbe an.",
    motion: "Bewegung",
    motionFull: "Volle Bewegung",
    motionReduced: "Reduzieren",
    motionHint: "Übergänge und Mikroanimationen reduzieren (Barrierefreiheit).",
    preview: "Vorschau",
    previewBtn: "Beispiel-Schaltfläche",
    previewBadge: "Label",
    accentIndigo: "Indigo",
    accentBlue: "Blau",
