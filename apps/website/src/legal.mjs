// Hukuki metinler — apps/mobile/src/legal/index.ts (ADR-079) kanonik kaynağının
// birebir kopyası (v1.0 · 2026-06-11). Fark oluşursa uygulamadaki sürüm geçerlidir;
// sayfalarda bu not basılır. Metin değişirse İKİ yer birlikte güncellenir.
import { CONTACT_EMAIL } from "./site.mjs";

/** @typedef {{ h: string, p: string }} LegalSection */
/** @typedef {{ slugTr: string, slugEn: string, tr: { title: string, sections: LegalSection[] },
 *   en: { title: string, sections: LegalSection[] }, version: string, updated: string }} LegalDoc */
